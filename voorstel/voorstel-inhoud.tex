...
Deel twee bouwt verder voort op dit grafiekmodel om dan een LLM te trainen die eenvoudig informatie eruit kan halen en teruggeven.
%---------- Stand van zaken ---------------------------------------------------
...
\subsection{CosmosDB}
\subsubsection{Waarom CosmosDB gebruiken}
