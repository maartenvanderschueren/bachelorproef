...
Met de implementatie van dit systeem wordt er gestreefd naar de optimalisatie van klanttevredenheid en besparingen binnen een bedrijf, in dit geval Arcelor Mittal Gent.
\begin{figure}[h!]
    \centering
